...
- **THEN** the dialog lists each unsupplied card with side and absent-vs-unselectable-vs-exhausted reason, states that zero items were moved, and does not blame the Params key.
