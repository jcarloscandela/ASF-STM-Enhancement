      ...
      <ul class="asf_stm_tabs" style="margin: 0;padding: 0;">
        <li class="asf_stm_tab">
          ...
          <div id="asf_stm_tab-content1" class="asf_stm_content">
            <fieldset>
              ...
              <div class="asf-stm-margin-bottom">
                ...
                <input
                  type="checkbox"
                  id="matchFriends"
                  ${settings.matchFriends ? "checked" : ""}
                  class="asf-stm-checkbox"
                />
              </div>
            </fieldset>
            ...
            <fieldset>
              ...
              <div class="asf-stm-margin-bottom">
                ...
                <a
                  ...
                  data-tooltip-text="Don't match with bots that has less or more than required limit of items in steam inventory. 0 means no limit on number of items"
                >
                  <img src="${questionmarkURL}" />
                </a>
              </div>
              <div class="asf-stm-margin-bottom">${sortSelectsHtml}</div>
            </fieldset>
            ...
            <fieldset>
              ...
              <div class="asf-stm-margin-bottom">
                ...
                <input
                  ...
                  id="preventClose"
                  class="asf-stm-checkbox"
                  ${settings.preventClose ? "checked" : ""}
                />
                <a
                  class="tooltip hover_tooltip"
                  data-tooltip-text="A dialog box will prevent navigation and exitting the page to avoid losing progess."
                >
                  <img src="${questionmarkURL}" />
                </a>
              </div>
            ...
            <fieldset
              style="display: grid;grid-template-columns: repeat(2, 1fr);grid-template-rows: repeat(3, 1fr);gap: 12px;"
            >
              ...
              <div style="grid-column-start: 1;grid-row-start: 4;">
                <span class="asf-stm-span">Inventory scan delay (ms):</span>
                <input
                  type="number"
                  id="inventoryScanDelay"
                  value=${settings.inventoryScanDelay}
                  min="1"
                  class="asf-stm-input"
                />
              </div>
        ...
        <li class="asf_stm_tab">
          ...
          <div id="asf_stm_tab-content2" class="asf_stm_content">
            <fieldset>
              ...
              <a
                class="tooltip hover_tooltip"
                data-tooltip-text="Custom text that will be included automatically with your trade offers created through STM while using this userscript. To remove this functionality, simply delete the text."
              >
                <img src="${questionmarkURL}" />
              </a>
            </fieldset>
            ...
            <fieldset>
              ...
              <select id="doAfterTrade" name="after-trade" class="asf-stm-select asf-stm-margin-bottom">
                ...
                <option value="CLOSE_WINDOW" ${settings.doAfterTrade === "CLOSE_WINDOW" ? "selected" : ""}>
                  Close window
                </option>
            ...
            <fieldset>
              ...
              <div class="asf-stm-margin-bottom">
                ...
                <input
                  ...
                  class="asf-stm-checkbox asf-stm-margin-bottom"
                />
                <a
                  class="tooltip hover_tooltip"
          ...
          <div class="asf_stm_content" id="asf_stm_tab-content4">
            <fieldset>
              ...
              <div class="asf-stm-margin-bottom">
                ...
                <input
                  type="checkbox"
                  id="useScanFilters"
                  ${settings.useScanFilters ? "checked" : ""}
                  class="asf-stm-checkbox"
                />
                <a
                  class="tooltip hover_tooltip"
                  data-tooltip-text="Filter badges to cut short the duration of the scan."
                >
                  <img src="${questionmarkURL}" />
                </a>
                <br />
                ...
                <input
                  type="checkbox"
                  id="autoAddScanFilters"
                  ${settings.autoAddScanFilters ? "checked" : ""}
                  class="asf-stm-checkbox"
                />
                <a
                  class="tooltip hover_tooltip"
                  data-tooltip-text="Add new scan filters from a fresh scan (clear all your filters)."
                >
                  <img src="${questionmarkURL}" />
                </a>
                <br />
                ...
                <input
                  type="checkbox"
                  id="autoDeleteScanFilters"
                  ${settings.autoDeleteScanFilters ? "checked" : ""}
                  class="asf-stm-checkbox"
                />
                <a
                  class="tooltip hover_tooltip"
                  data-tooltip-text="Delete scan filters from badges without duplicates."
                >
                  <img src="${questionmarkURL}" />
                </a>
              </div>
            ...
            <fieldset>
              ...
              <div class="asf-stm-margin-bottom">
                ...
                <input
                  type="number"
                  id="addScanFilterAppId"
                  step="10"
                  required
                  class="asf-stm-input asf-stm-margin-right appid-validity"
                />
                <button id="addScanFilterButton" class="btn_blue_steamui btn_small asf-stm-margin-right">
                  <span>Add scan filter</span>
                </button>
                <span id="addScanFilterStatus"></span>
              </div>
              <div class="asf-stm-margin-bottom">
                <button
                  onclick="document.querySelector('#clearScanFilters').style.visibility = 'visible'"
                  class="btn_plum btn_small asf-stm-margin-right"
                >
                  <span>Clear scan filters</span>
                </button>
                <button id="clearScanFilters" class="btn_darkred_white_innerfade btn_small" style="visibility: hidden;">
            ...
            <fieldset>
              ...
              <div
                id="asf-stm-filters"
                style="column-gap: 4px;display: flex;flex-wrap: wrap;justify-content: flex-start;"
              >
                ${scanFiltersTemplate}
              </div>
            </fieldset>
