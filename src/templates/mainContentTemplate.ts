...
export function renderMainContent(data: MainContentData): string {
  return /* HTML */ `
    ...
    <div
      id="asf_stm_filters"
      style="position: fixed; z-index: 1000; right: 5px; bottom: 45px; transition-duration: 500ms; transition-timing-function: ease; margin-right: -50%; padding: 5px; max-width: 40%; display: inline-block; border-radius: 2px; background:${data.filterBackgroundColor}; color: #67c1f5;"
    >
