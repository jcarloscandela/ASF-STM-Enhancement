      ...
      <div class="badge_row is_link goo_untradable_note showcase_slot">
        <div class="notLoggedInText">
          <div title="View badge progress for this game">
            <a
              ...
              href="https://steamcommunity.com/${data.myProfileLink}/gamecards/${data.appId}/"
            >
              <img
                style="background-color: var(--gpStoreDarkerGrey);"
                height="69"
                alt="${data.gameName}"
                src="https://steamcdn-a.akamaihd.net/steam/apps/${data.appId}/capsule_184x69.jpg"
        ...
        <div class="showcase_slot">
          <div class="showcase_slot profile_header">
            <div
              class="badge_info_unlocked profile_xp_block_mid avatar_block_status_in-game badge_info_title badge_row_overlay"
              style="height: 15px;"
            >
              You
            </div>
        ...
        <div class="showcase_slot profile_header">
          <a
            href="https://steamcommunity.com/${data.botProfileLink}/gamecards/${data.appId}/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <div
              class="badge_info_unlocked profile_xp_block_mid avatar_block_status_online badge_info_title badge_row_overlay ellipsis"
              style="height: 15px;"
            >
              ${data.botNickname}
            </div>
