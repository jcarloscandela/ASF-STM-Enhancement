        ...
        <div style="float: left;" class="">
            <div class="user_avatar playerAvatar online">
                <a target="_blank" rel="noopener noreferrer" href="https://steamcommunity.com/${data.botProfileLink}">
                    <img src="https://avatars.cloudflare.steamstatic.com/${data.botAvatarHash === null ? "fef49e7fa7e1997310d705b2a6158ff8dc1cdfeb" : data.botAvatarHash}.jpg" />
                </a>
            </div>
        </div>
        <div class="badge_title">
            &nbsp;<a target="_blank" rel="noopener noreferrer" href="https://steamcommunity.com/${data.botProfileLink}">${data.botNickname}</a>${data.any}
            &ensp;<span style="color: #8F98A0;">(${data.botTotalInventoryCount} items)</span>
            &ensp;<a id="blacklist_${data.botSteamId}" data-tooltip-text="Blacklist this bot" class="tooltip hover_tooltip">
